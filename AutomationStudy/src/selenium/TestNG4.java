...
public class TestNG4 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Locate Search box
		WebElement search = browserObject.findElement(By.className("lg_button"));
		
		search.click();
		
		WebElement academies = browserObject.findElement(By.xpath("//*[@id=\"learn-press-user-profile\"]/ul/li[3]/a"));
		
		academies.click();
		
		
		WebElement subscribe = browserObject.findElement(By.xpath("//*[@id=\"tab-academies\"]/div/div/ul/li[1]/form/div"));

		subscribe.click();
		
		
		WebElement pay = browserObject.findElement(By.xpath("//*[@id=\"learn-press-payment\"]/ul/li/label"));
		...
		WebElement cardnumber = browserObject.findElement(By.id("card-element"));
